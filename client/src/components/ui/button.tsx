...
import { createButtonAriaProps, ARIA_ROLE_BUTTON } from "../../lib/aria-utils"
...
export interface ButtonProps
  ...
  asChild?: boolean
  /**
   * Accessible label for the button. If not provided, the button text will be used.
   */
  ariaLabel?: string
  /**
...
function Button({
  ...
  // Create ARIA props
  const ariaProps = createButtonAriaProps(
    accessibleLabel,
    pressed,
    expanded,
    controls
